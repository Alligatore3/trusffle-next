...
<template>
  <div class="relative flex min-h-screen w-full flex-col overflow-x-hidden">
    ...
    <!-- Footer -->
    <footer
      class="border-t border-border-color/50 bg-background-light dark:bg-background-dark py-12"
    >
      <div
        class="mx-auto max-w-7xl px-6 flex flex-col md:flex-row justify-between items-center gap-6"
      >
        <div class="flex items-center gap-2">
          <span class="material-symbols-outlined text-primary-content dark:text-white"
            >diamond</span
          >
